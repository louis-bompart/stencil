...
export function createNodeSys(c: { process?: any; logger?: Logger } = {}): CompilerSystem {
  ...
  sys.lazyRequire = new NodeLazyRequire(nodeResolve, {
    '@types/jest': { minVersion: '24.9.1', recommendedVersion: '27.0.3' },
    jest: { minVersion: '24.9.1', recommendedVersion: '27.0.3'},
    'jest-cli': { minVersion: '24.9.0', recommendedVersion: '27.4.5' },
